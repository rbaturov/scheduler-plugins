...
require (
	...
	k8s.io/kube-scheduler v0.25.14
	k8s.io/kubernetes v1.25.14
...
require (
	...
	k8s.io/cloud-provider v0.25.14 // indirect
	k8s.io/csi-translation-lib v0.25.14 // indirect
	k8s.io/gengo v0.0.0-20211129171323-c02415ce4185 // indirect
	k8s.io/kube-openapi v0.0.0-20220803162953-67bda5d908f1 // indirect
	k8s.io/metrics v0.25.14 // indirect
	k8s.io/mount-utils v0.25.14 // indirect
...
replace (
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.26.0-alpha.0.0.20231013002525-fdcfc2723dc8
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.25.14
	k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.25.14
	k8s.io/metrics => k8s.io/metrics v0.25.14
	k8s.io/mount-utils => k8s.io/mount-utils v0.25.14
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.25.14
