...
require (
	...
	k8s.io/csi-translation-lib v0.26.9 // indirect
	k8s.io/dynamic-resource-allocation v0.26.9 // indirect
	k8s.io/gengo v0.0.0-20220902162205-c0856e24416d // indirect
	k8s.io/kms v0.26.9 // indirect
	k8s.io/kube-openapi v0.0.0-20221012153701-172d655c2280 // indirect
	k8s.io/metrics v0.26.9 // indirect
	k8s.io/mount-utils v0.26.9 // indirect
